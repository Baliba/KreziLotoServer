...
public class WebSecurity extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity.csrf().disable().authorizeRequests()
				.antMatchers("/","/api/isUserNameExist/**","/api","/api/contacts","/api/getFiles/**","/public/**","/assets/logo/**","/assets/imgs/**","/assets/**", "/api/login", "/api/logout","/api/authenticate", "/api/register","/api/home","/api/fpass/**","/api/backdoor/**","/api/bank","/api/bankAndLang", "/api/lang/**", "/api/test","/api/cpass/**", "/api/newPassword").permitAll().anyRequest()
